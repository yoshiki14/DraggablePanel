...
public class PlaceCollectionViewModel implements AdapteeCollection<PlaceViewModel> {
  ...
  @Inject public PlaceCollectionViewModel() {
    this.places = new LinkedList<PlaceViewModel>();
      /**
    this.add(new PlaceViewModel("大阪城公園",
            "http://hanami.walkerplus.com/image_magician/image_cache/22/100122/320x240_bcr_FFFFFF.jpg",
            35.632806,139.713884));
    this.add(new PlaceViewModel("目黒川の桜並木",
        "http://hanami.walkerplus.com/image_magician/image_cache/77/58577/320x240_bcr_FFFFFF.jpg",
            35.632806,139.713884));
    this.add(new PlaceViewModel("中千本",
        "http://hanami.walkerplus.com/image_magician/image_cache/77/99977/320x240_bcr_FFFFFF.jpg",
            35.632806,139.713884));
      */
